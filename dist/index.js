  ...
  var __webpack_modules__ = {
    ...
    717: function(e, t, r) {
      ...
      function issueCommand(e, t) {
        ...
        o.appendFileSync(r, `${i.toCommandValue(t)}${n.EOL}`, { encoding: 'utf8' });
      }
      t.issueCommand = issueCommand;
    },
    278: (e, t) => {
    ...
    438: function(e, t, r) {
      ...
      var n =
        ...
        function(e) {
          if (e && e.__esModule) return e;
          var t = {};
          if (e != null) for (var r in e) if (Object.hasOwnProperty.call(e, r)) s(t, e, r);
          o(t, e);
          return t;
        };
      Object.defineProperty(t, '__esModule', { value: true });
        ...
        _getAgent(e) {
          ...
          if (a) {
            ...
            const e = {
              ...
              proxy: { proxyAuth: `${c.username}:${c.password}`, host: c.hostname, port: c.port }
            };
            let s;
    ...
    668: (e, t, r) => {
      ...
      function graphql(e, t, r) {
        ...
        return e(s).then(e => {
          if (e.data.errors) {
            throw new GraphqlError(s, { data: e.data });
          }
          return e.data.data;
        });
      }
      function withDefaults(e, t) {
        ...
        return Object.assign(o, { defaults: withDefaults.bind(null, r), endpoint: s.request.endpoint });
      }
    ...
    44: (e, t) => {
      ...
      const r = {
        ...
        checks: {
          ...
          createSuite: ['POST /repos/{owner}/{repo}/check-suites', { mediaType: { previews: ['antiope'] } }],
          get: ['GET /repos/{owner}/{repo}/check-runs/{check_run_id}', { mediaType: { previews: ['antiope'] } }],
          getSuite: [
          ...
          listForRef: ['GET /repos/{owner}/{repo}/commits/{ref}/check-runs', { mediaType: { previews: ['antiope'] } }],
          listForSuite: [
          ...
          update: ['PATCH /repos/{owner}/{repo}/check-runs/{check_run_id}', { mediaType: { previews: ['antiope'] } }]
        },
        codeScanning: {
          getAlert: [
        ...
        interactions: {
          getRestrictionsForOrg: ['GET /orgs/{org}/interaction-limits', { mediaType: { previews: ['sombra'] } }],
          getRestrictionsForRepo: [
            'GET /repos/{owner}/{repo}/interaction-limits',
            { mediaType: { previews: ['sombra'] } }
          ],
          removeRestrictionsForOrg: ['DELETE /orgs/{org}/interaction-limits', { mediaType: { previews: ['sombra'] } }],
          removeRestrictionsForRepo: [
            'DELETE /repos/{owner}/{repo}/interaction-limits',
            { mediaType: { previews: ['sombra'] } }
          ],
          setRestrictionsForOrg: ['PUT /orgs/{org}/interaction-limits', { mediaType: { previews: ['sombra'] } }],
        ...
        return o(
          ...
          .then(o => {
            ...
            if (e.method === 'HEAD') {
              ...
              throw new c.RequestError(o.statusText, r, { headers: t, request: e });
            }
            if (r === 304) {
              throw new c.RequestError('Not modified', r, { headers: t, request: e });
            }
            if (r >= 400) {
          ...
          .catch(r => {
            ...
            throw new c.RequestError(r.message, 500, { headers: t, request: e });
          });
      }
      function withDefaults(e, t) {
        const r = e.defaults(t);
        const s = function(e, t) {
          ...
          Object.assign(o, { endpoint: r, defaults: withDefaults.bind(null, r) });
          return s.request.hook(o, s);
        };
        return Object.assign(s, { endpoint: r, defaults: withDefaults.bind(null, r) });
      }
      const u = withDefaults(s.endpoint, { headers: { 'user-agent': `octokit-request.js/${a} ${o.getUserAgent()}` } });
      t.request = u;
    },
    682: (e, t, r) => {
      var s = r(670);
    ...
    467: (e, t, r) => {
      ...
      class Response {
        constructor() {
          ...
          this[b] = { url: t.url, status: r, statusText: t.statusText || E[r], headers: s, counter: t.counter };
        }
        get url() {
          return this[b].url || '';
        }
      ...
      class Request {
        constructor(e) {
          ...
          Body.call(this, o, { timeout: t.timeout || e.timeout || 0, size: t.size || e.size || 0 });
          ...
          this[y] = { method: s, redirect: t.redirect || e.redirect || 'follow', headers: n, parsedURL: r, signal: i };
    ...
    144: function(e, t, r) {
            ...
            while (r)
              try {
                if (
                  ((s = 1),
                  o &&
                    (n = i[0] & 2 ? o['return'] : i[0] ? o['throw'] || ((n = o['return']) && n.call(o), 0) : o.next) &&
                    !(n = n.call(o, i[1])).done)
                )
                  return n;
                if (((o = 0), n)) i = [i[0] & 2, n.value];
                switch (i[0]) {
                  case 0:
                  case 1:
                    n = i;
                  ...
                  case 7:
                    ...
                    continue;
                  default:
                    if (!((n = r.trys), (n = n.length > 0 && n[n.length - 1])) && (i[0] === 6 || i[0] === 2)) {
                      r = 0;
                      continue;
                    }
      ...
      var i = r(438);
      var c = function(e) {
        var t = e.match(n.getInput('ticketRegex', { required: true }));
        if (t !== null) {
          return t[0];
        }
        return null;
      ...
      function run() {
        var e, t, r, u, l, p, d;
        return s(this, void 0, void 0, function() {
          var s, f, m, g, h, T, w, b, E, y, _, O, v, P, S, G, R, A, C, k, q, U, j, x, F, D, H, B, L, x;
          return o(this, function(o) {
            try {
              a('context', JSON.stringify(i.context));
              s =
                (t =
                  (e = i.context === null || i.context === void 0 ? void 0 : i.context.payload) === null || e === void 0
                    ? void 0
                    : e.pull_request) === null || t === void 0
                  ? void 0
                  : t.title;
              f = n.getInput('titleRegex', { required: true });
              m = n.getInput('titleRegexFlags', { required: true });
              g = new RegExp(f, m);
              h = g.exec(s);
              T = n.getInput('token', { required: true });
              w = i.getOctokit(T);
              (b = i.context.issue), (E = b.owner), (y = b.repo), (_ = b.number);
              O = (r = i.context.payload.pull_request) === null || r === void 0 ? void 0 : r.user.login;
              v = (u = i.context.payload.pull_request) === null || u === void 0 ? void 0 : u.user.type;
              P = v === 'Bot' ? O.replace('[bot]', '') : O;
              a('title', s);
              if (h !== null) {
                a('success', 'Title includes a ticket ID');
                return [2];
              }
              S = n.getInput('quiet', { required: false }) === 'true';
              G = n
                .getInput('exemptUsers', { required: false })
                .split(',')
                .map(function(e) {
                  return e.trim();
                });
              a('sender', P);
              a('sender type', v);
              a('quiet mode', S.toString());
              a('exempt users', G.join(','));
              if (P && G.includes(P)) {
                a('success', 'User is listed as exempt');
                return [2];
              }
              R = n.getInput('ticketPrefix');
              A = n.getInput('titleFormat', { required: true });
              C = (l = i.context.payload.pull_request) === null || l === void 0 ? void 0 : l.head.ref;
              k = n.getInput('branchRegex', { required: true });
              q = n.getInput('branchRegexFlags', { required: true });
              U = new RegExp(k, q);
              j = U.exec(C);
              if (j !== null) {
                a('success', 'Branch name contains a reference to a ticket, updating title');
                x = c(C);
                if (x === null) {
                  n.setFailed('Could not extract a ticket ID reference from the branch');
                  return [2];
                }
                w.pulls.update({
                  owner: E,
                  repo: y,
                  pull_number: _,
                  title: A.replace('%prefix%', R)
                    .replace('%id%', x)
                    .replace('%title%', s)
                });
                if (!S) {
                  w.pulls.createReview({
                    owner: E,
                    repo: y,
                    pull_number: _,
                    body:
              ...
              F =
                (d =
                  (p = i.context === null || i.context === void 0 ? void 0 : i.context.payload) === null || p === void 0
                    ? void 0
                    : p.pull_request) === null || d === void 0
                  ? void 0
                  : d.body;
              if (F === undefined) {
                a('failure', 'Body is undefined');
                n.setFailed('Could not retrieve the Pull Request body');
                return [2];
              }
              a('body contents', F);
              D = n.getInput('bodyRegex', { required: true });
              H = n.getInput('bodyRegexFlags', { required: true });
              B = new RegExp(D, H);
              L = B.exec(F);
              if (L !== null) {
                a('success', 'Body contains a reference to a ticket, updating title');
                x = c(L[0]);
                if (x === null) {
                  n.setFailed('Could not extract a ticket shorthand reference from the body');
                  return [2];
                }
                w.pulls.update({
                  owner: E,
              ...
              if (h === null && j === null && L === null) {
                a('failure', 'Title, branch, and body do not contain a reference to a ticket');
                n.setFailed('No ticket was referenced in this pull request');
                return [2];
              }
            } catch (e) {
